...
===============
*/
void idCmdCompletionLocal::CompleteFilename( pointer dir, pointer ext, bool stripExt )
{
    matchCount = 0;
    shortestMatch[0] = 0;
...
===============
*/
void idCmdCompletionLocal::CompleteCommand( valueType* cmd, bool doCommands, bool doCvars )
{
...
void idCmdCompletionLocal::VariableSizeDraw( field_t* edit, sint x, sint y, sint size, bool showCursor, bool noColorEscape, float32 alpha )
{
    ...
    if( size == SMALLCHAR_WIDTH )
    {
        ...
        clientScreenSystem->DrawSmallStringExt( x, y, str, color, false, noColorEscape );
    }
    else
    {
    ...
    if( showCursor )
    {
        ...
        if( size == SMALLCHAR_WIDTH )
        {
            float32 xlocation = x + clientScreenSystem->ConsoleFontStringWidth( str + prestep, edit->cursor - prestep );
...
==================
*/
void idCmdCompletionLocal::Draw( field_t* edit, sint x, sint y, bool showCursor, bool noColorEscape, float32 alpha )
{
    VariableSizeDraw( edit, x, y, SMALLCHAR_WIDTH, showCursor, noColorEscape, alpha );
}
...
==================
*/
void idCmdCompletionLocal::BigDraw( field_t* edit, sint x, sint y, bool showCursor, bool noColorEscape )
{
    VariableSizeDraw( edit, x, y, BIGCHAR_WIDTH, showCursor, noColorEscape, 1.0f );
}
