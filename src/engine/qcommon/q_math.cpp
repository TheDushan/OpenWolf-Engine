...
vec4_t g_color_table[MAX_CCODES] =
{
    ...
    {1.000f, 0.686f, 0.000f, 1.000f},	//9
    {0.996f, 0.671f, 0.604f, 1.000f},	//a
...
void Q_GetVectFromHexColor(pointer color_code, vec4_t color) {
    ...
    for(i = 0; i < Q_NumOfColorCodeDigits(color_code); i++) {
        ...
        if(!is_short_hex_color) {
            // determine if this is the first or seconad charcter of
            // the particul hex value
            if((i % 2) == 0) {
                val *= 16;
            }
        }
