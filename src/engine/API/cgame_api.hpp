...
struct cgameImports_t
{
    ...
    bool( *getCameraInfo )( sint camNum, sint time, vec3_t* origin, vec3_t* angles, float32* fov );
...
{
public:
    virtual void Init( sint serverMessageNum, sint serverCommandSequence, sint clientNum, bool demoPlayback ) = 0;
    ...
    virtual void DrawActiveFrame( sint serverTime, stereoFrame_t stereoView, bool demoPlayback ) = 0;
