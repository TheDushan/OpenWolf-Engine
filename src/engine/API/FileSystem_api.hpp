...
public:
    ...
    virtual valueType *BuildOSPath(pointer base, pointer game,
                                   pointer qpath) = 0;
    ...
    virtual valueType *ShiftedStrStr(pointer string, pointer substring,
                                     sint shift) = 0;
    ...
    virtual sint AddFileToList(valueType *name,
                               valueType *list[MAX_FOUND_FILES], sint nfiles) = 0;
    virtual valueType **ListFilteredFiles(pointer path, pointer extension,
                                          valueType *filter, uint64 *numfiles) = 0;
    ...
    virtual uint64 GetFileList(pointer path, pointer extension,
                               valueType *listbuf, uint64 bufsize) = 0;
    virtual uint CountFileList(valueType **list) = 0;
    virtual valueType **ConcatenateFileLists(valueType **list0,
            valueType **list1, valueType **list2) = 0;
    ...
    virtual bool ComparePaks(valueType *neededpaks, sint len,
                             bool dlstring) = 0;
    ...
    virtual void PureServerSetLoadedPaks(pointer pakSums,
                                         pointer pakNames) = 0;
