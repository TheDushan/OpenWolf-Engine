...
#ifndef __CVARSYSTEM_API_HPP__
#define __CVARSYSTEM_API_HPP__
...
public:
    ...
    virtual void LatchedVariableStringBuffer(pointer var_name,
            valueType *buffer, uint64 bufsize) = 0;
