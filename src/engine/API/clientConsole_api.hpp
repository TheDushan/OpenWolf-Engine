...
#ifndef __CLIENTCONSOLE_API_HPP__
#define __CLIENTCONSOLE_API_HPP__
...
typedef struct {
    ...
    sint
    rowsVisible;   // number of full rows that can currently be rendered in a page
