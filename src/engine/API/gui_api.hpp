...
sint trap_CM_LerpTag( orientation_t* tag, const refEntity_t* refent, pointer tagName, sint startIndex );
...
valueType* trap_TranslateString( pointer string ) __attribute__( ( format_arg( 1 ) ) );
