...
==============
*/
void idServerNetChanSystemLocal::NetchanEncode(client_t *client,
        msg_t *msg, valueType *commandString) {
    uchar8 key, *string;
    sint srdc, sbit;
...
==============
*/
void idServerNetChanSystemLocal::NetchanDecode(client_t *client,
        msg_t *msg) {
    uchar8 key, *string;
    sint serverId, messageAcknowledge, reliableAcknowledge, i, index, srdc,
         sbit;
    bool soob;
    ...
    string = reinterpret_cast<uchar8 *>
             (client->reliableCommands[reliableAcknowledge & (MAX_RELIABLE_COMMANDS -
                                                           1)]);
    index = 0;
...
=================
*/
void idServerNetChanSystemLocal::NetchanTransmitNextFragment(
    client_t *client) {
...
void idServerNetChanSystemLocal::NetchanTransmit(client_t *client,
    ...
    if(client->netchan.unsentFragments) {
        ...
        Q_strcpy_s(netbuf->lastClientCommandString,
...
=================
*/
bool idServerNetChanSystemLocal::NetchanProcess(client_t *client,
        msg_t *msg) {
    bool ret;
