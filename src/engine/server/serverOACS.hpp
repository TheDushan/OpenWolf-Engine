...
#ifndef __SERVEROACS_HPP__
#define __SERVEROACS_HPP__
...
public:
    ...
    static float64 ExtendedRecordInterframeInitValue(sint client,
            sint feature);
    ...
    static valueType *ExtendedRecordFeaturesToCSV(valueType *csv_string,
            sint max_string_size, feature_t *interframe, sint savewhat, sint client);
    static valueType *ExtendedRecordPlayersTableToCSV(valueType *csv_string,
            sint max_string_size, playerstable_t playerstable);
    static void ExtendedRecordSetFeatureValue(interframeIndex_t feature,
            float64 value, sint client);
