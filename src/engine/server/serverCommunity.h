...
public:
    ...
    static void logString( sint client_num, valueType* area, valueType* message );
    ...
    static void ProcessWeapon( user_stats_t* user_stats, valueType* weapon, valueType** tokens );
    ...
    static void ProcessGeneric( pointer* l_stats, valueType** tokens, sint* i_stats );
    static void SaveStatistics( void );
    static void SaveUserStats( user_stats_t* user_stats, FILE* fstats );
    static sint SaveUserStatsOptimal( user_stats_t* user_stats, valueType* fline );
    static sint PrintStat( valueType* out, sint count_stats, pointer section_mnemonic, const sint* stats, pointer* stats_mnemonics );
