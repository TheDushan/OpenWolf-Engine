...
bool StringsContainWord(pointer heystack, pointer heystack2,
                        valueType *needle) {
...
sint GetMaterialType(pointer name) {
    ...
    if(StringsContainWord(name, name, "plastic")) {
    ...
    } else if(StringsContainWord(name, name, "mp/flag") ||
              StringsContainWord(name, name, "lightground")) {
        return MATERIAL_SOLIDMETAL;
    } else if(!StringsContainWord(name, name, "trainer") &&
              StringsContainWord(name, name, "train")) {
        return MATERIAL_SOLIDMETAL;
    ...
    } else if(StringsContainWord(name, name, "/weapon") ||
              StringsContainWord(name, name, "scope") ||
              StringsContainWord(name, name, "pistol") ||
              StringsContainWord(name, name, "cannon")  ||
              StringsContainWord(name, name, "rifle") ||
              StringsContainWord(name, name, "rocket")) {
        return MATERIAL_HOLLOWMETAL;
    } else if(StringsContainWord(name, name, "metal") ||
              StringsContainWord(name, name, "pipe") ||
              StringsContainWord(name, name, "shaft") ||
              StringsContainWord(name, name, "elevator") ||
              StringsContainWord(name, name, "vent")) {
        return MATERIAL_SOLIDMETAL;
        ...
        return MATERIAL_GRAVEL;
              ...
              StringsContainWord(name, name, "ground")) {
        return MATERIAL_DIRT;
    } else if(StringsContainWord(name, name, "snow")) {
        return MATERIAL_SNOW;
    } else if(StringsContainWord(name, name, "hood") ||
              StringsContainWord(name, name, "cloth") ||
    ...
    } else if(StringsContainWord(name, name, "armor") ||
              StringsContainWord(name, name, "armour")) {
        return MATERIAL_ARMOR;
    } else if(StringsContainWord(name, name, "flesh") ||
              StringsContainWord(name, name, "body") ||
              StringsContainWord(name, name, "leg") ||
              StringsContainWord(name, name, "hand") ||
              StringsContainWord(name, name, "head") ||
              StringsContainWord(name, name, "hips") ||
              StringsContainWord(name, name, "torso") ||
              StringsContainWord(name, name, "tentacles") ||
              StringsContainWord(name, name, "face") ||
              StringsContainWord(name, name, "arms")) {
        return MATERIAL_FLESH;
    } else if(StringsContainWord(name, name,
                                 "players") | StringsContainWord(name, name, "boots") ||
              StringsContainWord(name, name, "accesories") ||
              StringsContainWord(name, name, "accessories") ||
              StringsContainWord(name, name, "holster")) {
        return MATERIAL_FABRIC;
    ...
    } else if(StringsContainWord(name, name, "computer") ||
              StringsContainWord(name, name, "console") ||
              StringsContainWord(name, name, "button") ||
              StringsContainWord(name, name, "terminal") ||
              StringsContainWord(name, name, "switch") ||
              StringsContainWord(name, name, "panel") ||
              StringsContainWord(name, name, "control")) {
        return MATERIAL_COMPUTER;
    } else if(StringsContainWord(name, name, "fabric")) {
        return MATERIAL_FABRIC;
    } else if(StringsContainWord(name, name, "leaf") ||
              StringsContainWord(name, name, "leaves") ||
              StringsContainWord(name, name, "fern") ||
              StringsContainWord(name, name, "vine")) {
        return MATERIAL_GREENLEAVES;
    } else if(StringsContainWord(name, name, "wood") ||
              (StringsContainWord(name, name, "tree") &&
               !StringsContainWord(name, name, "street"))) {
        ...
        return MATERIAL_ICE;
               ...
               StringsContainWord(name, name, "foliage")) &&
              (StringsContainWord(name, name, "long") ||
               StringsContainWord(name, name, "tall") ||
               StringsContainWord(name, name, "thick"))) {
        ...
        return MATERIAL_CONCRETE;
    } else if((StringsContainWord(name, name, "tile") ||
               StringsContainWord(name, name, "lift"))) {
        return MATERIAL_SOLIDMETAL;
    } else if(StringsContainWord(name, name, "tile") ||
              StringsContainWord(name, name, "lift")) {
        return MATERIAL_TILES;
    } else if(StringsContainWord(name, name, "glass") ||
              StringsContainWord(name, name, "light") ||
              StringsContainWord(name, name, "screen") ||
              StringsContainWord(name, name, "lamp")) {
        return MATERIAL_GLASS;
    } else if(StringsContainWord(name, name, "flag")) {
        return MATERIAL_FABRIC;
    } else if(StringsContainWord(name, name, "column") ||
              StringsContainWord(name, name, "stone") ||
              StringsContainWord(name, name, "statue")) {
        return MATERIAL_MARBLE;
    } else if(StringsContainWord(name, name, "red") ||
              StringsContainWord(name, name, "blue") ||
              StringsContainWord(name, name, "yellow") ||
              StringsContainWord(name, name, "white") ||
              StringsContainWord(name, name, "monitor")) {
        return MATERIAL_PLASTIC;
    } else if(StringsContainWord(name, name, "trim") ||
              StringsContainWord(name, name, "step") ||
              StringsContainWord(name, name, "pad")) {
        return MATERIAL_ROCK;
    } else if(!StringsContainWord(name, name, "players")) {
        return MATERIAL_TILES;
    } else if(!StringsContainWord(name, name, "players")) {
        ...
        return MATERIAL_CONCRETE;
              ...
              (StringsContainWord(name, name, "trim") ||
               StringsContainWord(name, name, "step") ||
               StringsContainWord(name, name, "pad"))) {
        return MATERIAL_CONCRETE;
    } else if(StringsContainWord(name, name, "out") &&
              (StringsContainWord(name, name, "frame") ||
               StringsContainWord(name, name, "wall") ||
               StringsContainWord(name, name, "round") ||
               StringsContainWord(name, name, "crate") ||
               StringsContainWord(name, name, "trim") ||
               StringsContainWord(name, name, "support") ||
               StringsContainWord(name, name, "step") ||
               StringsContainWord(name, name, "pad") ||
               StringsContainWord(name, name, "weapon") ||
               StringsContainWord(name, name, "gun"))) {
        return MATERIAL_CONCRETE;
    } else if(StringsContainWord(name, name, "frame") ||
              StringsContainWord(name, name, "wall") ||
              StringsContainWord(name, name, "round") ||
              ...
              StringsContainWord(name, name, "gun")) {
        return MATERIAL_CONCRETE;
    } else if(StringsContainWord(name, name, "black") ||
              StringsContainWord(name, name, "items")) {
        return MATERIAL_PLASTIC;
    } else if(StringsContainWord(name, name, "refract") ||
              StringsContainWord(name, name, "reflect")) {
        return MATERIAL_PLASTIC;
    ...
    if(StringsContainWord(name, name, "plastic")) {
        return MATERIAL_PLASTIC;
              ...
              StringsContainWord(name, name, "transport") ||
              StringsContainWord(name, name, "crate") ||
              StringsContainWord(name, name, "container") ||
              StringsContainWord(name, name, "barrel") ||
              StringsContainWord(name, name, "train") ||
              StringsContainWord(name, name, "crane") ||
              StringsContainWord(name, name, "plate") ||
              StringsContainWord(name, name, "cargo")) {
        return MATERIAL_PLASTIC;
    } else if(StringsContainWord(name, name, "grass") ||
              StringsContainWord(name, name, "foliage")) {
        return MATERIAL_SHORTGRASS;
    ...
    if(StringsContainWord(name, name, "plastic") ||
            StringsContainWord(name, name, "medpack")) {
        return MATERIAL_PLASTIC;
    } else if(StringsContainWord(name, name, "water") &&
              !StringsContainWord(name, name, "splash") &&
              !StringsContainWord(name, name, "drip")) {
        return MATERIAL_WATER;
    }
...
static bool CMod_AddEdgeToBrush(const vec3_t p0, const vec3_t p1,
                                cbrushedge_t *edges, sint *numEdges) {
    sint i;
...
static void CMod_CreateBrushSideWindings(void) {
    sint             i, j, k, numEdges, edgesAlloc, totalEdgesAlloc = 0,
                                                    totalEdges = 0;
    winding_t      *w;
...
void CMod_LoadSurfaces(lump_t *surfs, lump_t *verts, lump_t *indexesLump) {
    drawVert_t     *dv, *dv_p;
    dsurface_t     *in;
    sint             count, i, j, numVertexes, width, height, shaderNum,
                     numIndexes, *index, *index_p;
    cSurface_t     *surface;
    ...
    for(i = 0; i < count; i++, in++) {
        if(LittleLong(in->surfaceType) == MST_PATCH) {
            sint j = 0, k = 0, rowLimit = in->patchHeight - 1,
            ...
            // create the internal facet structure
            surface->sc = CM_GenerateTriangleSoupCollide(numVertexes, vertexes,
                          numIndexes, indexes);
        }
    }
}
...
uint CM_LumpChecksum(lump_t *lump) {
    return LittleLong(MD4System->BlockChecksum(cmod_base + lump->fileofs,
                      lump->filelen));
}
...
==================
*/
void idCollisionModelManagerLocal::LoadMap(pointer name, bool clientload,
        sint *checksum) {
    sint *buf, i, length;
    dheader_t header;
...
===================
*/
clipHandle_t idCollisionModelManagerLocal::TempBoxModel(const vec3_t mins,
        const vec3_t maxs, sint capsule) {
...
===================
*/
void idCollisionModelManagerLocal::ModelBounds(clipHandle_t model,
...
===================
*/
sint idCollisionModelManagerLocal::BoxOnPlaneSide(vec3_t emins,
        vec3_t emaxs, cplane_t *p) {
    float32           dist1, dist2;
    sint             sides;
    ...
    switch(p->signbits) {
        case 0:
            dist1 = p->normal[0] * emaxs[0] + p->normal[1] * emaxs[1] + p->normal[2] *
                    emaxs[2];
            dist2 = p->normal[0] * emins[0] + p->normal[1] * emins[1] + p->normal[2] *
                    emins[2];
            break;

        case 1:
            dist1 = p->normal[0] * emins[0] + p->normal[1] * emaxs[1] + p->normal[2] *
                    emaxs[2];
            dist2 = p->normal[0] * emaxs[0] + p->normal[1] * emins[1] + p->normal[2] *
                    emins[2];
            break;

        case 2:
            dist1 = p->normal[0] * emaxs[0] + p->normal[1] * emins[1] + p->normal[2] *
                    emaxs[2];
            dist2 = p->normal[0] * emins[0] + p->normal[1] * emaxs[1] + p->normal[2] *
                    emins[2];
            break;

        case 3:
            dist1 = p->normal[0] * emins[0] + p->normal[1] * emins[1] + p->normal[2] *
                    emaxs[2];
            dist2 = p->normal[0] * emaxs[0] + p->normal[1] * emaxs[1] + p->normal[2] *
                    emins[2];
            break;
