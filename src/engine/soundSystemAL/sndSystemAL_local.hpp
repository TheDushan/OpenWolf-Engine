...
public:
    ...
    static void src_play( sfxHandle_t sfx, vec3_t origin, sint entnum, sint entchannel );
    
    // Start a looping sound effect
    static void src_loop_clear( void );
    static void src_loop( sint priority, sfxHandle_t sfx, const vec3_t origin, const vec3_t velocity, sint entnum );
     ...
     * Stream
     */
    static void stream_raw( sint samples, sint rate, sint width, sint channels, const uchar8* data, float32 volume );
    ...
    */
    ...
    static void src_setup( srcHandle_t src, sfxHandle_t sfx, sint priority, sint entity, sint channel, bool local );
