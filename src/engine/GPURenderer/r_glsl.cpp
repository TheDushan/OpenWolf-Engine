...
void GLSL_SetUniformMat4BoneMatrix( shaderProgram_t* program, sint uniformNum, /*const*/ mat4_t* matrix, sint numMatricies )
{
    ...
    {
        CL_RefPrintf( PRINT_WARNING, "GLSL_SetUniformMat4BoneMatrix: wrong type for uniform %i in program %s\n", uniformNum, program->name );
        return;
    }
    
    if( numMatricies > glRefConfig.glslMaxAnimatedBones )
    {
        CL_RefPrintf( PRINT_WARNING, "GLSL_SetUniformMat4BoneMatrix: too many matricies (%d/%d) for uniform %i in program %s\n",
...
void idRenderSystemLocal::InitGPUShaders( void )
{
    ...
    if( !GLSL_InitGPUShader( &tr.textureColorShader, "texturecolor", attribs, true, extradefines, true ) )
    {
    ...
    for( i = 0; i < DLIGHTDEF_COUNT; i++ )
    {
        ...
        if( !GLSL_InitGPUShader( &tr.dlightShader[i], "dlight", attribs, true, extradefines, false ) )
        {
    ...
    for( i = 0; i < LIGHTDEF_COUNT; i++ )
    {
        ...
        if( !GLSL_InitGPUShader( &tr.lightallShader[i], "lightall", attribs, true, extradefines, true ) )
        {
    ...
    for( i = 0; i < SHADOWMAPDEF_COUNT; i++ )
    {
        ...
        if( !GLSL_InitGPUShader( &tr.shadowmapShader[i], "shadowfill", attribs, true, extradefines, true ) )
        {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.ssrShader, "ssr", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.ssrCombineShader, "ssrCombine", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.pshadowShader, "pshadow", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.down4xShader, "down4x", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.bokehShader, "bokeh", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.tonemapShader, "tonemap", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.shadowmaskShader, "shadowmask", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.ssaoShader, "ssao", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.prefilterEnvMapShader, "prefilterEnvMap", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.darkexpandShader, "darkexpand", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.gaussianBlurShader[1], "gaussian_blur", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.multipostShader, "multipost", attribs, true, extradefines, true ) )
    {
        Com_Error( ERR_FATAL, "Could not load darkexpand shader!" );
    }
    ...
    GLSL_SetUniformInt( &tr.multipostShader, UNIFORM_SCREENDEPTHMAP, TB_COLORMAP );
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.lensflareShader, "lensflare", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.anamorphicDarkenShader, "anamorphic_darken", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.anamorphicBlurShader, "anamorphic_blur", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.anamorphicCombineShader, "anamorphic_combine", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.hdrShader, "truehdr", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.ssgiShader, "ssgi", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.ssgiBlurShader, "ssgiBlur", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.dofShader, "depthOfField", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.esharpeningShader, "esharpening", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.esharpening2Shader, "esharpening2", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.texturecleanShader, "textureclean", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.vibrancyShader, "vibrancy", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.anaglyphShader, "anaglyph", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.texturedetailShader, "texturedetail", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.rbmShader, "rbm", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.contrastShader, "contrast", attribs, true, extradefines, true ) )
    {
    ...
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';
    if( !GLSL_InitGPUShader( &tr.fxaaShader, "fxaa", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.bloomDarkenShader, "bloom_darken", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.bloomBlurShader, "bloom_blur", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.bloomCombineShader, "bloom_combine", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.waterShader, "water", attribs, true, extradefines, true ) )
    {
    ...
    if( !GLSL_InitGPUShader( &tr.underWaterShader, "underwater", attribs, true, extradefines, true ) )
    {
        Com_Error( ERR_FATAL, "Could not load water shader!" );
    }
    ...
    if( !GLSL_InitGPUShader( &tr.testcubeShader, "testcube", attribs, true, extradefines, true ) )
    {
