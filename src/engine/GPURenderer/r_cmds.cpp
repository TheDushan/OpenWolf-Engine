...
=============
*/
static bool R_ClipRegion(float32 *x, float32 *y, float32 *w, float32 *h,
                         float32 *s1, float32 *t1, float32 *s2, float32 *t2) {
...
=============
*/
void idRenderSystemLocal::DrawStretchPic(float32 x, float32 y, float32 w,
...
void R_SetColorMode(GLboolean *rgba, stereoFrame_t stereoFrame,
                    sint colormode) {
...
=============
*/
void idRenderSystemLocal::TakeVideoFrame(sint width, sint height,
        uchar8 *captureBuffer, uchar8 *encodeBuffer, bool motionJpeg) {
