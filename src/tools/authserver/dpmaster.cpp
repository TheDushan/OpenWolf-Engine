...
//
// -------------------------------------------------------------------------------------
// File name:   dpmaster.cpp
// Created:
// Compilers:   Microsoft (R) C/C++ Optimizing Compiler Version 19.26.28806 for x64,
//              gcc (Ubuntu 9.3.0-10ubuntu2) 9.3.0
// Description: An open authentication server
// -------------------------------------------------------------------------------------
////////////////////////////////////////////////////////////////////////////////////////
...
static void PrintBanner(void) {
    ...
    if(! banner_printed) {
        Com_Printf(MSG_NORMAL,
                   "\n"
                   "OpenWolf authserver \nBased on dpmaster, an open master server source code\n"
...
====================
*/
static cmdline_status_t Cmdline_Option(const cmdlineopt_t *opt,
...
static void PrintCmdlineOptionHelp(const cmdlineopt_t *opt) {
    bool has_short_name = (opt->short_name != '\0');
                        ...
                        if(first_param != NULL) {
                            if(nb_params > 1) {
                                ...
                                if(opt_params != NULL) {
                                    ...
                                    memcpy((void *)&opt_params[1], argv[ind + 1],
                                           (nb_params - 1) * sizeof(const char *));
                                } else {
...
====================
*/
static void PrintCmdlineOptionsHelp(const char *pool_name,
                                    const cmdlineopt_t *opts) {
...
int main(int argc, const char *argv []) {
    ...
    for(;;) {
        ...
        for(sock_ind = 0;
            ...
            if(packet[0] != '\xFF' || packet[1] != '\xFF' || packet[2] != '\xFF' ||
                    packet[3] != '\xFF') {
                Com_Printf(MSG_WARNING,
            ...
            HandlePacketMessage(packet + 4, nb_bytes - 4, &address, addrlen, crt_sock);
        }
    }
}
